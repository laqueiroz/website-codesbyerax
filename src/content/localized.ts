...
export const content: Record<Locale, Copy> = {
  pt: {
    ...
    product: {
      ...
      windowsTitle:"Aviso do Windows", windows:"O Windows poderá exibir uma mensagem de proteção por ser um aplicativo distribuído fora da Microsoft Store. Confirme que o arquivo veio do site oficial da Codes by Erax.",
