...
export default function sitemap(): MetadataRoute.Sitemap {
  const bases = {pt:["","/vinculo-tutoria","/blog","/orcamento","/privacidade","/termos","/licencas","/changelog","/feedback","/status"],en:["","/vinculo-tutoria","/blog","/quote","/privacy","/terms","/licenses","/changelog","/feedback","/status"]} as const;
